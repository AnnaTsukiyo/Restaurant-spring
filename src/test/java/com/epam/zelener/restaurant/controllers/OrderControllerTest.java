...
class OrderControllerTest {
    ...
    void init() {
        ...
        fullOrderDto = new FullOrderDto("1", "2", List.of(new Dish(1L, 120, "Sushi California", 200, SUSHI, true, ACTIVE, List.of(
                new Ingredient(1L, List.of(new Food(1L, "Salmon", "Smoked salmon from Norway", true, ACTIVE, LocalDate.of(2022, Month.DECEMBER, 1),
