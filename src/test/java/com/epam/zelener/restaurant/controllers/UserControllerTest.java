...
import static com.epam.zelener.restaurant.model.Role.GUEST;
...
class UserControllerTest {
    ...
    @BeforeEach
    void init() {
        fullUserDto = new FullUserDto("1", "Jonas Kahnwald", "+3806567898", "GUEST", "Winden", "ACTIVE",
                "2000-01-01", "jonas@gmail.com", "passwordP1","passwordP1");
    }
    ...
    void createUser_positiveTest() throws Exception {
        ...
        mockMvc.perform(post("/api/user/create")
                ...
                .andExpect(content().string(createdUser.getEmail() + ": user was created"));
    ...
    void createUser_negativeTest() throws Exception {
        ...
        mockMvc.perform(post("/api/user/create")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.fields", hasItem("email")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.errors", hasItem("{User with such email already exists}")));
    ...
    void getUserByEmail_positiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/user/get/jonas@gmail.com")
                        .content(mapper.writeValueAsBytes(fullUserDto))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.role", is("GUEST")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", is("ACTIVE")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.dateOfBirth", is("2000-01-01")))
                .andDo(print());
    }
    ...
    void updateUser_positiveTest() throws Exception {
        ...
        mockMvc.perform(patch("/api/user/update/{email}", "jonas@gmail.com")
                        .content(toJson(updateUserDto))
                        .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string("Johannes Kahnwald --User with email is updated successfully"));
    }
    ...
    void getByEmail_negativeTest() throws Exception {
        ...
        mockMvc.perform(get("/api/user/get/marta@gmail.com"))
                .andExpect(status().isNotFound())
                .andExpect(content().string("marta@gmail.com -- User with such email {} doesn't exist "));
    ...
    void getAllUsers_positiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/user/all")
                        ...
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].fullName", is("Jonas Kahnwald")))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].role", is("GUEST")))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].status", is("ACTIVE")))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].dateOfBirth", is("2000-01-01")));
    ...
    void deactivateUser_positiveTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/user/deactivate/" + fullUserDto.getEmail()))
                .andExpect(status().isOk())
                .andExpect(content().string(fullUserDto.getEmail() + " –- User's status with an email {} is changed to INACTIVE"));
    }
    ...
    void deactivateUser_negativeTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/user/deactivate/{email}", fullUserDto.getEmail()))
                .andExpect(status().isConflict())
                .andExpect(content().string(fullUserDto.getEmail() + " –- User with such email is already INACTIVE"));
    }
    ...
    void getAllByPages_positiveTest() throws Exception {
        ...
        mockMvc.perform(get("/api/user/all/0"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].fullName", is("Jonas Kahnwald")))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].fullName", is("Marta Norton")))
                .andExpect(MockMvcResultMatchers.jsonPath("$[2].fullName", is("Paul Newman")));
    }
}
