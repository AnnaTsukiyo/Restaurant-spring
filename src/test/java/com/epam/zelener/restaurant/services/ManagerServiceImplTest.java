...
class ManagerServiceImplTest {
    ...
    void deactivateManager_positiveTest() {
        manager.setId(2L);
        lenient().when(managerRepository.findById(manager.getId())).thenReturn(Optional.of(manager));
    ...
    void getManagerByName_positiveTest() {
        ...
        Manager manager = new Manager(2L, "Alexa", 29, List.of(new User(1L, "Jonas Tidermann", "+3806567898", "address", "admin@gmail.com", "passwordP1", "passwordP1",
    ...
    @Test
    void getManagerById() {
        Manager managerNew = new Manager(3L, "Alex", 33, List.of(new User(2L, "Jared Salvatore", "+3806568898", "address", "jared@gmail.com", "passwordP123", "passwordP1",
        ...
        FullManagerDto dto = new FullManagerDto();
        dto.setId("3");
        lenient().when(managerRepository.findManagerById(3L)).thenReturn(managerNew);
    ...
    void updateManagerName_positiveTest() {
        lenient().when(managerRepository.findManagerById(manager.getId())).thenReturn(manager);
        lenient().when(managerRepository.save(manager)).thenReturn(manager);
        lenient().when(managerRepository.findManagerByName(manager.getName())).thenReturn(manager);
    ...
    void testIsStatusActive_positiveTest() {
        Manager newManager = new Manager(2L, "Michael", 22, List.of(new User(1L, "Johan Schmidt", "+3806557898", "address", "schmidt@gmail.com", "PpPasswordP1", "passwordP1",
