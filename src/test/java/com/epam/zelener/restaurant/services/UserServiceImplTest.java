...
//        user = new User(1L, "Jonas Tidermann", "+3806567898", "address", "admin@gmail.com", "passwordP1",
...
//        User user = new User(1L, "Jonas Tidermann", "+3806567898", "address", email, "passwordP1",
//                "2000-01-01", Role.GUEST, ACTIVE, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now());
...
//
//        UserCreateDto userDto = new UserCreateDto("Marti Schulz", "CUSTOMER", "marti@gmail.com", "Ppassword123", "Ppassword123");
...
//        lenient().when(userRepository.findById(Math.toIntExact(user.getId()))).thenReturn(Optional.of(user));
//        lenient().when(userRepository.save(user)).thenReturn(user);
...
//        User user = new User(1L, "Jonas Tidermann", "+3806567898", "address", "admin@gmail.com", "passwordP1",
//                "2000-01-01", Role.GUEST, ACTIVE, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now());
//        FullUserDto userDto = new FullUserDto();
