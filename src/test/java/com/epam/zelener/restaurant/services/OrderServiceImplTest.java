...
//        order = new Order(1L, new User(1L, "Jonas Tidermann", "+3806567898", "address", "admin@gmail.com", "passwordP1",
//                "2000-01-01", Role.GUEST, ACTIVE, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now()),
//                List.of(new Dish(1L, 120, "Sushi California", 200, SUSHI, true, List.of(
...
//        Order order = new Order(2L, new User(1L, "Mariam Minelli", "+3807867898", "address", "mariam@gmail.com", "MariamPass@123",
...
//
//        OrderCreateDto orderDto = new OrderCreateDto( "1",List.of(new Dish(1L, 120, "Sushi California", 200, SUSHI, true,
