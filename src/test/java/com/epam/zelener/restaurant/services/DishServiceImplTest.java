...
class DishServiceImplTest {
    ...
    void getDishByTitle_positiveTest() {
        ...
        Dish dish = new Dish(5L, 30, "Green tea", 300, DRINKS, true, Status.ACTIVE, List.of(
    ...
    @DisplayName("JUNIT Test DishServiceImpl getByCategory_positiveTest() method --positive test case scenario")
    @Test
    void getByCategory_positiveTest() {

        lenient().when(dishRepository.findByCategory(Pageable.ofSize(1), SUSHI)).thenReturn(Collections.singletonList(dish));
        Assertions.assertEquals(dish.getTitle(), "Sushi California");
    }
