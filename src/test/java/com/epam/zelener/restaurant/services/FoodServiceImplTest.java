...
class FoodServiceImplTest {
    ...
    void setUp() {
        ...
        food = new Food(1L, "Coffee", "Coffee black Arabica 5+", true, LocalDate.of(2022, Month.DECEMBER, 1),
    ...
    void deactivateFood_positiveTest() {
        lenient().when(foodRepository.findById(Math.toIntExact((food.getId())))).thenReturn(Optional.of(food));
        lenient().when(foodRepository.save(food)).thenReturn(food);
    ...
    void getFoodById_positiveTest() {
        Food foodNew = new Food(4L, "Coffee R", "Coffee Robusta 10", true, LocalDate.of(2022, Month.DECEMBER, 1),
                LocalDate.of(2023, Month.APRIL, 10),
                LocalDateTime.now(), LocalDateTime.now());
    ...
    void getFoodByTitle_positiveTest() {
        ...
        Food food = new Food(2L, "Black Tea with Bergamot", "Black Tea Ahmad with Bergamot ", true, LocalDate.of(2022, Month.NOVEMBER, 1),
